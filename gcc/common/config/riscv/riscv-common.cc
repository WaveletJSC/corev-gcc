...
static const struct riscv_ext_version riscv_ext_version_table[] =
{
  ...
  {"zca", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcb", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcf", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcmb", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcmp", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcmpe", ISA_SPEC_CLASS_NONE, 0, 70},
  {"zcmt", ISA_SPEC_CLASS_NONE, 0, 70},
